...
`)}function M(e){return`<li class="gallery-item">
            ...
            </li>`}function E(e){e.classList.remove("loader-hidden")}function H(e){e.classList.add("loader-hidden")}async function L(e,s,o){y.defaults.baseURL="https://pixabay.com";const n={key:"44349742-ecc8a7b60aea5585f0c207813",q:e,image_type:"photo",orientation:"horizontal",safesearch:!0,per_page:o,page:s};try{return(await y.get("/api/",{params:n})).data}catch(t){console.log(t)}}const q="/goit-js-hw-12/assets/icon-close-5bc7b79a.svg",v=document.querySelector(".search-form");document.querySelector(".search-form__input");const u=document.querySelector(".gallery"),h=document.querySelector(".loader"),g=document.querySelector(".load-more__button");let d,S=new P(".gallery a"),i,m=15;function O(){u.innerHTML=""}function w(){return i=i+1}function f(){g.classList.remove("active")}function T(){g.classList.add("active")}function k(){return i=1}function $(e){if(i>e)return f(),_.error({class:"izt-toast-message",message:"We're sorry, but you've reached the end of search results.",messageSize:"16",messageLineHeight:"24",messageColor:"#ffffff",backgroundColor:"#b51b1b",iconUrl:q,position:"topRight",theme:"dark"})}function z(e,s,o){let n=e.scrollTop,t=null;function r(a){t===null&&(t=a);const c=a-t,p=l(c,n,s,o);e.scrollTop=p,c<o&&requestAnimationFrame(r)}function l(a,c,p,C){return a/=C/2,a<1?p/2*a*a+c:(a--,-p/2*(a*(a-2)-1)+c)}requestAnimationFrame(r)}async function A(){const e=await L(d,i,m),s=Math.ceil(e.totalHits/m);if(e.hits.length<m||i>=s)console.log("No more pages to load."),f();else{u.insertAdjacentHTML("beforeend",b(e.hits)),S.refresh();const r=u.querySelectorAll("li")[0].getBoundingClientRect().height*2;z(u,r,500),w(),$(s)}}async function N(e){if(e.preventDefault(),d=e.target.elements.query.value.trim(),k(),f(),d.length!==0){E(h);try{const o=await L(d,i,m);O(),o.hits.length===0?_.show({class:"izt-toast-message",message:"Sorry, there are no images matching your search query. Please try again!",messageSize:"16",messageLineHeight:"24",messageColor:"#ffffff",backgroundColor:"#b51b1b",iconUrl:q,position:"topRight",theme:"dark"}):(u.insertAdjacentHTML("beforeend",b(o.hits)),w(),S.refresh(),o.hits.length===m?T():f())}catch(o){console.log(o)}H(h)}v.reset()}v.addEventListener("submit",N);g.addEventListener("click",A);
