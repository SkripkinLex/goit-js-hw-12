...
`)}function P(e){return`<li class="gallery-item">
            ...
            </li>`}function C(e){e.classList.remove("loader-hidden")}function O(e){e.classList.add("loader-hidden")}async function h(e,s,o){d.defaults.baseURL="https://pixabay.com";const i={key:"44349742-ecc8a7b60aea5585f0c207813",q:e,image_type:"photo",orientation:"horizontal",safesearch:!0,per_page:o,page:s};try{return(await d.get("/api/",{params:i})).data}catch(t){console.log(t)}}const _="/goit-js-hw-12/assets/icon-close-5bc7b79a.svg",m=document.querySelector(".search-form");document.querySelector(".search-form__input");const b=document.querySelector(".gallery"),f=document.querySelector(".loader"),n=document.querySelector(".load-more__button"),u=15;let a=1,l,p;p=new w(".gallery a");function g(){b.innerHTML=""}function L(){return a=a+1}function v(){n.classList.remove("active")}function k(){return a=1}function E(e){if(a>e)return v(),y.error({class:"izt-toast-message",message:"We're sorry, but you've reached the end of search results.",messageSize:"16",messageLineHeight:"24",messageColor:"#ffffff",backgroundColor:"#b51b1b",iconUrl:_,position:"topRight",theme:"dark"})}async function q(){const e=Math.ceil(data.totalHits/u);if(a>=e)console.log("No more pages to load."),n.disabled=!0,n.style.display="none";else{const s=await h(l,a,u);b.insertAdjacentHTML("beforeend",S(s.hits)),p.refresh(),L(),E(e)}}m.addEventListener("submit",async e=>{if(e.preventDefault(),l=e.target.elements.query.value.trim(),k(),v(),l.length!==0){C(f);try{const o=await h(l,a,u);q(),o.hits.length===0?(y.show({class:"izt-toast-message",message:"Sorry, there are no images matching your search query. Please try again!",messageSize:"16",messageLineHeight:"24",messageColor:"#ffffff",backgroundColor:"#b51b1b",iconUrl:_,position:"topRight",theme:"dark"}),g()):(g(),L(),p.refresh(),n.classList.add("active"))}catch(o){console.log(o)}O(f)}m.reset()});n.addEventListener("click",q);
