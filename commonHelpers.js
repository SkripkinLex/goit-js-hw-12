...
`)}function S(e){return`<li class="gallery-item">
            ...
            </li>`}function P(e){e.classList.remove("loader-hidden")}function M(e){e.classList.add("loader-hidden")}async function _(e){m.defaults.baseURL="https://pixabay.com";const s={key:"44349742-ecc8a7b60aea5585f0c207813",q:e,image_type:"photo",orientation:"horizontal",safesearch:!0,per_page:L,page:n};try{return(await m.get("/api/",{params:s})).data}catch(o){console.log(o)}}const O="/goit-js-hw-12/assets/icon-close-5bc7b79a.svg",f=document.querySelector(".search-form");document.querySelector(".search-form__input");const p=document.querySelector(".gallery"),y=document.querySelector(".loader"),l=document.querySelector(".load-more__button"),L=15;let n=1,a=null,i,u;u=new q(".gallery a");function g(){p.innerHTML=""}function b(){return n=n+1}function C(){l.classList.remove("active")}function $(){return n=1}async function v(){const e=Math.ceil(a.totalHits/L);n>=e?(console.log("No more pages to load."),l.disabled=!0):(a=await _(i),p.insertAdjacentHTML("beforeend",h(a.hits)),u.refresh(),b())}f.addEventListener("submit",async e=>{if(e.preventDefault(),i=e.target.elements.query.value.trim(),$(),C(),i.length!==0){P(y);try{a=await _(i),v(),a.hits.length===0?(w.show({class:"izt-toast-message",message:"Sorry, there are no images matching your search query. Please try again!",messageSize:"16",messageLineHeight:"24",messageColor:"#ffffff",backgroundColor:"#b51b1b",iconUrl:O,position:"topRight",theme:"dark"}),g()):(g(),p.insertAdjacentHTML("beforeend",h(a.hits)),b(),u.refresh(),l.classList.add("active"))}catch(o){console.log(o)}M(y)}f.reset()});l.addEventListener("click",v);
