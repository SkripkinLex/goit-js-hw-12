...
`)}function M(e){return`<li class="gallery-item">
            ...
            </li>`}function E(e){e.classList.remove("loader-hidden")}function H(e){e.classList.add("loader-hidden")}async function L(e,o,s){y.defaults.baseURL="https://pixabay.com";const n={key:"44349742-ecc8a7b60aea5585f0c207813",q:e,image_type:"photo",orientation:"horizontal",safesearch:!0,per_page:s,page:o};try{return(await y.get("/api/",{params:n})).data}catch(t){console.log(t)}}const q="/goit-js-hw-12/assets/icon-close-5bc7b79a.svg",v=document.querySelector(".search-form");document.querySelector(".search-form__input");const u=document.querySelector(".gallery"),h=document.querySelector(".loader"),g=document.querySelector(".load-more__button");let p,S=new P(".gallery a"),i,d=15;function O(){u.innerHTML=""}function w(){return i=i+1}function f(){g.classList.remove("active")}function T(){g.classList.add("active")}function k(){return i=1}function $(e){if(i>e)return f(),_.error({class:"izt-toast-message",message:"We're sorry, but you've reached the end of search results.",messageSize:"16",messageLineHeight:"24",messageColor:"#ffffff",backgroundColor:"#b51b1b",iconUrl:q,position:"topRight",theme:"dark"})}function z(e,o,s){let n=e.scrollTop,t=null;function r(a){t===null&&(t=a);const c=a-t,m=l(c,n,o,s);e.scrollTop=m,c<s&&requestAnimationFrame(r)}function l(a,c,m,C){return a/=C/2,a<1?m/2*a*a+c:(a--,-m/2*(a*(a-2)-1)+c)}requestAnimationFrame(r)}async function A(){const e=await L(p,i,d),o=Math.ceil(e.totalHits/d);if(e.hits.length===0||i>=o)return f(),"No more pages to load.";{u.insertAdjacentHTML("beforeend",b(e.hits)),S.refresh();const r=u.querySelectorAll("li")[0].getBoundingClientRect().height*2;z(u,r,500),w(),$(o)}}async function N(e){if(e.preventDefault(),p=e.target.elements.query.value.trim(),k(),f(),p.length!==0){E(h);try{const s=await L(p,i,d);O(),s.hits.length===0?_.show({class:"izt-toast-message",message:"Sorry, there are no images matching your search query. Please try again!",messageSize:"16",messageLineHeight:"24",messageColor:"#ffffff",backgroundColor:"#b51b1b",iconUrl:q,position:"topRight",theme:"dark"}):(u.insertAdjacentHTML("beforeend",b(s.hits)),w(),S.refresh(),s.hits.length===d?T():f())}catch(s){console.log(s)}H(h)}v.reset()}v.addEventListener("submit",N);g.addEventListener("click",A);
